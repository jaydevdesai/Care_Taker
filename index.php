    ...
    <div class="container" style="border-bottom-width: 0px;width: auto;">
        ...
        <nav class="collapse navigation navbar-collapse navbar-right" role="navigation">
            <ul id="nav" class="nav navbar-nav">
                ...
                <li class="current"><a href="index.php">Log In</a></li>
            </ul>
        </nav>
        <!-- /main nav -->
    </div>
    ...
    <div class="logmod__wrapper">
        <div class="logmod__container">
            <ul class="logmod__tabs">
                ...
                <li data-tabtar="lgm-2"><a href="#">CareTaker</a></li>
            </ul>
                ...
                <div class="logmod__tab lgm-1">
                    ...
                    <div class="logmod__form">
                        <form accept-charset="utf-8" action="Utility_Login.php?type=User" method="post" class="simform">
                            ...
                            <div class="simform__actions">
                                <span class="simform__actions"><center>New to CareTaker? <a class="special" href="SignUp.php" role="link">Click HERE</a> to Sign-Up!</center></span>
                            </div>
                        </form>
                    </div>
                </div>
                        ...
                        <form accept-charset="utf-8" action="Utility_Login.php?type=SP" method="post" class="simform">
                            ...
                            <div class="simform__actions">
                                <input class="sumbit" name="submit_sp" type="submit" value="Log In" />
                                    <span class="simform__actions-sidetext">
                                        <a class="special" role="link" href="FPassword.php?type=CT">Forgot your password?</a>
                                    </span>
                            </div>
                        </form>
                    </div>
